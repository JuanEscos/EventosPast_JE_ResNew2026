...
def test_pipeline_imports_the_published_csv_into_flowdata():
    assert "aniadir_resultados_por_prueba_para_WP_a_JE_FlowData2026.php" in pipeline, (
        "El pipeline debe importar el CSV publicado en JE_FlowData2026"
    )

def test_weekly_watchdog_is_complete_and_handles_madrid_dst():
    required = [
        "0 7 * * 3",
        "0 8 * * 3",
